...
parser = argparse.ArgumentParser(
    prog="bibata_bee_builder",
    description="'Bibata Bee cursor build python script.",
)
...
comments = {
    "Bibata-Bee-Modern": "Rounded edge Bibata cursors with Bee stripes",
    "Bibata-Bee-Original": "Sharp edge Bibata cursors with Bee stripes",
}
